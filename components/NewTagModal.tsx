...
export default function NewTagModal({
  ...
  const validateName = (name: string): string | null => {
    ...
    if (trimmedName.length > 30) {
      return 'Tag name is too long (max 30 characters)';
    }
  ...
  const handleConfirm = async () => {
    const validationError = validateName(tagName);
    if (validationError) {
              ...
              <View style={styles.content}>
                ...
                <View style={styles.header}>
                  <View style={styles.headerLeft}>
                    <Tag size={20} color="#f4ad3d" strokeWidth={1.5} />
                ...
                <View style={styles.buttonContainer}>
                  ...
                  >
                    <LinearGradient
                      ...
                      style={[styles.confirmButtonGradient, (isCreating || !tagName.trim()) && styles.disabledButton]}
                    >
